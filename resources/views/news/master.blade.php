...
<html lang="en">
    ...
    <head>
        ...
        <link href="{{ asset('newstemp/lib/animate/animate.min.css') }}" rel="stylesheet">
        <link href="{{ asset('newstemp/lib/owlcarousel/assets/owl.carousel.min.css') }}" rel="stylesheet">


        <!-- Customized Bootstrap Stylesheet -->
        <link href="{{ asset('newstemp/css/bootstrap.min.css') }}" rel="stylesheet">

        <!-- Template Stylesheet -->
        <link href="{{ asset('newstemp/css/style.css') }}" rel="stylesheet">
    </head>
    ...
    <body>
        ...
        <script src="{{ asset('newstemp/lib/easing/easing.min.js') }}"></script>
        <script src="{{ asset('newstemp/lib/waypoints/waypoints.min.js') }}"></script>
        <script src="{{ asset('newstemp/lib/owlcarousel/owl.carousel.min.js') }}"></script>

        <!-- Template Javascript -->
        <script src="{{ asset('newstemp/js/main.js') }}"></script>
    </body>
